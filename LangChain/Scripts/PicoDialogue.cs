...
public class PicoDialogue : MonoBehaviour, IChatClientListener
{
    ...
    void Start()
    {
        ...
        // Subscribe to the OnLLMResponseReceived event
        ...
        {
            Debug.LogError("InitializePuerts instance is not available.");
        }
    ...
    public void OnSendButtonClicked()
    {
        if (playerInputField != null && !isAwaitingResponse)
        {
            ...
            // Call InitializePuerts to process the user input
            InitializePuerts.Instance.ProcessUserInput(playerInput);
        }
        else
        {
